      ...
      <div className="col-md-6 col-lg-12">
                            <div className="card">
                                ...
                                <div className="card-body position-relative pt-2 pb-2">
                                    <p className="ratings_five mb-4"> <b>4.7</b> <span>Out of 5</span> </p>
                                    <ul className="d-flex list-unstyled listitems">
                                        ...
                                        <li><i className="fa-solid fa-star text-warning"></i></li>
                                        <li><i className="fa-solid fa-star text-warning"></i></li>
                                        <li><i className="fa-solid fa-star text-muted text-warning"></i></li>
                                                    ...
                                                    <div className="d-sm-flex justify-content-between align-items-center">
                                                        <div className="userlist_sect userstarlist">
                                                            ...
                                                            <ul className="d-flex list-unstyled">
                                                                ...
                                                                <li><i className="fa-solid fa-star text-warning "></i></li>
                                                                <li><i
                                                                        className="fa-solid fa-star text-warning text-muted"></i>
                                                                </li>
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="userlist_sect userstarlist">
                                                            ...
                                                            <ul className="d-flex list-unstyled">
                                                                ...
                                                                <li><i className="fa-solid fa-star text-warning"></i></li>
                                                                <li><i className="fa-solid fa-star text-warning"></i></li>
                                                                <li><i className="fa-solid fa-startext-warning"></i></li>
                                    ...
                                    <div className=" mt-2 text-center">
                                        <a href="#" className="text-purple"><b>View More</b></a>
                                    </div>
